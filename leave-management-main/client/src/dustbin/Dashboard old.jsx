...
<div className="text-center mb-8 bg-green-100 p-6 rounded-lg">
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {user.role === "Admin" ? (
          <>
            ...
            className="relative inline-flex items-center justify-center p-6 mb-4 text-xl font-medium text-white bg-gradient-to-br from-purple-600 to-blue-500 rounded-lg hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300"
            >
              User Register
            </NavLink>
            ...
            <NavLink to="/LeaveBalanceCount" className="relative inline-flex items-center justify-center p-6 mb-4 text-xl font-medium text-white bg-gradient-to-br from-red-200 via-red-300 to-yellow-200 rounded-lg hover:text-white focus:ring-4 focus:outline-none focus:ring-red-100">
            LeaveBalanceCount
            </NavLink>
          </>
        ) : (
  ...
  <div className="p-6 bg-white border rounded-lg shadow-lg max-w-[500px] min-w-[300px]">
