...
import LeaveBalanceCount from './components/LeaveBalanceCount';
import EmployeeLeaveCalendar from './components/Dashboard/EmployeeLeaveCalendar';
import LeaveCountGraphsCharts from './components/Dashboard/LeaveCountGraphsCharts';
import PermissionChart from './components/Dashboard/PermissionGraph';
      ...
      Menu
        ...
        >
          ...
          <Routes>
            ...
            <Route path="/PermissionChart" element={isLoggedIn ? <PermissionChart /> : <Login onLogin={setIsLoggedIn} />} />
