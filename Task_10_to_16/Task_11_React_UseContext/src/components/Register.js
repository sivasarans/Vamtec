...
function Register() {
    ...
    const handleDelete = (id) => { 
        ...
        const navigateToCountry = useCallback(() => {
            setshow("Country");
            console.log("Navigating to Country by Usecallback");
        }, [setshow]);
    ...
    return (
        ...
        <div className="bg-gray-100 flex flex-col items-center">
            ...
            <div className="text-center mb-5"> 
                <h1 className="text-3xl font-bold mb-5">Registered User's</h1>
                <div className="flex justify-center gap-4 flex-wrap">
                    <button onClick={navigateToCountry} className="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 mb-4">Add Country</button>
                    <button onClick={() => {setshow("State")}} className="bg-green-500 text-white font-bold py-2 px-4 rounded hover:bg-green-600 mb-4">Add State</button>
                    <button onClick={() => { setshow("MemoExample") }} className="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 mb-4">MemoExample</button>
    ...
    {displayList.map((user, index) => (
        <tr key={index}>
            ...
            <td className="border-2 border-green-300 px-4 py-2"> {user.photo ? (
                    ...
                    : ( "No Photo" )}</td>            
            <td className="border-2 border-green-300 px-4 py-2">{user.name || "N/A"}</td>
